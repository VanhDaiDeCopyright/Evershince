define([
  ...
  function changeLoginUser(userInput, userName) {
    ...
    userInput.click(function () {
      ...
      if (
        inputId == "mobile_number_user" ||
        inputId == "mobile_number_user_login"
      ) {
      ...
      function (value, element) {
        if ($.trim(telInput.val())) {
          if (telInput.intlTelInput("isValidNumber")) {
            countryCode.val(
              telInput.intlTelInput("getSelectedCountryData").iso2
            );
            return true;
          }
          return false;
